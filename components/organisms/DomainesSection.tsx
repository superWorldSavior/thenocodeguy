...
const domaines: Domaine[] = [
  {
    ...
    titleKey: 'btpTitle',
    tasksKey: 'btpTasks',
    image: '/images/homepage/gallery-btp.webp',
    icon: HardHat,
    featured: true,
  },
  {
    ...
    image: '/images/homepage/gallery-commerce.webp',
    icon: ShoppingCart,
  },
  {
    id: 'admin',
    titleKey: 'adminTitle',
    tasksKey: 'adminTasks',
    image: '/images/homepage/gallery-admin.webp',
    icon: FileStack,
  },
  {
    id: 'web',
    titleKey: 'webTitle',
    tasksKey: 'webTasks',
    image: '/images/homepage/gallery-web.webp',
    icon: Globe,
  },
]
              ...
              >
                ...
                <div className="relative aspect-[4/3] w-full overflow-hidden">
                  <Image
                    ...
                    title={t(domaine.titleKey as 'btpTitle')}
                    fill
