    ...
    <>
      ...
      <section className="px-4 pt-20 pb-12 sm:px-6 sm:pt-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto max-w-xl text-lg text-muted-foreground">{t("heroSubtitle")}</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {benefits.map((b) => (
              <div key={b.label} className="rounded-xl border border-border bg-card p-4 text-center">
                <div className="mx-auto mb-2 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10">
