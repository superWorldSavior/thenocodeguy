...
dependsOn: [60, 61, 62, 64, 65, 66, 67]
---

## Description
Remplacer le contenu actuel de app/[locale]/page.tsx par les nouvelles sections dans l'ordre correct. Supprimer toutes les anciennes sections inline (stats 99€, ancien how it works en 3 étapes, pricing teaser bandeau, anciennes agents cards). Importer et assembler : Hero → Profils (#61) → Comment ça marche (#64) → Témoignages (#65) → CTA Brief (#62) → Footer.

## Acceptance Criteria
- page.tsx contains exactly these sections in order: HeroSection, ProfilesSection, HowItWorksSection, TestimonialsSection, CTASection, Footer
